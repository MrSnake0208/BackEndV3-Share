...
data class OperatorCatalogResponse(val format: String = "myshare-operator-catalog", val version: Int = 1, val catalogVersion: String, val operators: List<OperatorCatalogEntity>)
